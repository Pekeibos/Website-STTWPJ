      ...
      <Section>
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
            <div className="lg:col-span-2">
                ...
                <h3 className="text-2xl font-bold font-serif mb-4 text-secondary dark:text-red-400 mt-8">Konsentrasi Studi</h3>
            ...
            <div className="bg-white dark:bg-gray-800 p-8 rounded-xl shadow-lg border border-gray-100 dark:border-gray-700 h-fit">
                <div className="bg-red-50 dark:bg-red-900/30 w-16 h-16 rounded-full flex items-center justify-center text-secondary dark:text-red-400 mb-6">
                    <Layers size={32} />
                </div>
                ...
                <div className="space-y-4 text-sm text-gray-600 dark:text-gray-400 mb-8">
                    <div className="flex justify-between border-b border-gray-100 dark:border-gray-700 pb-2">
                        <span>Gelar</span>
                        <span className="font-bold text-gray-900 dark:text-white">Magister Teologi (M.Th)</span>
                    </div>
                    <div className="flex justify-between border-b border-gray-100 dark:border-gray-700 pb-2">
                    ...
                    <div className="flex justify-between border-b border-gray-100 dark:border-gray-700 pb-2">
                        <span>Syarat</span>
                        <span className="font-bold text-gray-900 dark:text-white">S1 Teologi / S1 Umum (Matrikulasi)</span>
                    </div>
                </div>
